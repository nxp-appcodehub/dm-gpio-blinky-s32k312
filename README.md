...
This demo introduces the S32 Design Studio development workflow, including project build, flash, and debug operations, while demonstrating basic clock and GPIO configuration on the FRDM-A-S32K312 through onboard LED blinking. 

#### Boards: FRDM-A-S32K312
#### Categories: GPIO, Clock
#### Peripherals: SIUL2 (Port/DIO), Clock
...
2. Found demo you need by searching for the name directly. Open the project, click the **GitHub link** from this window, S32 Design Studio IDE will automatically retrieve project attributes then click **Next>**.
...
## 4. Results<a name="step4"></a>
 The onboard LED should toggle with a 500ms cadence (500ms on, 500ms off).
